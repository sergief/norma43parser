...
def test_parse_end_of_file():
    ...
    norma_43_document = Norma43Parser().parse(line_content)
...
class TestHeaderParser:
    ...
    def test_parse_header_bank_identifier(self):
        norma_43_document = Norma43Parser().parse(self.HEADER_CONTENT)
    ...
    def test_parse_header_start_date_different_format(self):
        ...
        norma_43_document = Norma43Parser(date_format="YMD").parse(header_content)
        assert norma_43_document.header.start_date == date(2018, 2, 1)
...
class TestFooterParser:
    ...
    def test_parse_header_bank_identifier(self):
        norma_43_document = Norma43Parser().parse(self.FOOTER_CONTENT)
...
2302AUTOMOCION LAGUNA SL 41001 SEVILLA ES"""
    ...
    def test_parse_branch_code(self):
        norma_43_document = Norma43Parser().parse(self.CONTENT)
